...
<template>
  <header class="bg-[var(--primary)] flex flex-col items-center pt-5 py-[30px] pb-[25px] dark:bg-[#181818]">
    <img :src="logo" class="w-[106px] h-[53px] mb-5" />
    <section class="px-[30px]">
      <div
        class="relative h-[45px] flex items-center justify-between bg-[var(--white)] dark:bg-[#3a3a3a] rounded-[5px] px-5 py-3"
      >
      ...
      />
          <input
            type="text"
            placeholder="검색하기"
            class="w-[330px] h-full focus:outline-none placeholder:text-[var(--grey)] text-[15px] dark:bg-[#3a3a3a]"
          />
    ...
    <section class="flex w-full px-[30px] pt-[25px] justify-evenly gap-x-6">
  ...
  />
      ...
      <!-- <button class="flex flex-col items-center" @click="emit('categoryClick', 'chatbot')">
        ...
        <span class="text-sm mt-[5px] text-[var(--white)]">챗봇</span>
      </button> -->
    </section>
  </header>
</template>
